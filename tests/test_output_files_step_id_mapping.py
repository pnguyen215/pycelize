...
class TestOutputFilesStepIdMapping:
    ...
    def test_output_files_with_matching_workflow_steps(self, client):
        ...
        mock_result = {
            ...
            "output_files": [
                {
                    "file_path": "./automation/workflows/2026/02/test-chat/outputs/file1.xlsx",
                    "step_id": "step-001"
                },
                {
                    "file_path": "./automation/workflows/2026/02/test-chat/outputs/file2.xlsx",
                    "step_id": "step-002"
                },
                {
                    "file_path": "./automation/workflows/2026/02/test-chat/intermediate/file3.xlsx",
                    "step_id": "step-003"
                },
            ],
            "workflow_steps": [
    ...
    def test_output_files_without_matching_workflow_steps(self, client):
        ...
        mock_result = {
            ...
            "output_files": [
                {
                    "file_path": "./automation/workflows/2026/02/test-chat/outputs/orphan_file.xlsx"
                    # No step_id - this file wasn't generated by any workflow step
                },
            ],
            "workflow_steps": [
                {
