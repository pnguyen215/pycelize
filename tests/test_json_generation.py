...
"""
    ...
    def test_generate_json_no_array_wrapper(
        self, service, sample_dataframe, output_file
    ):
    ...
    def test_generate_json_with_template_basic(
        self, service, sample_dataframe, output_file
    ):
    ...
    def test_generate_json_with_template_string(
        self, service, sample_dataframe, output_file
    ):
    ...
    def test_generate_json_with_template_nested_mode(
        self, service, sample_dataframe, output_file
    ):
    ...
    def test_generate_json_with_template_single_mode(
        self, service, sample_dataframe, output_file
    ):
    ...
    def test_generate_json_with_template_invalid_json(
        self, service, sample_dataframe, output_file
    ):
    ...
    def test_generate_json_with_template_missing_column(
        self, service, sample_dataframe, output_file
    ):
    ...
    def test_generate_json_pretty_print_false(
        self, service, sample_dataframe, output_file
    ):
