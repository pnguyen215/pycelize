...
class MessageHandler(ABC):
    ...
    @abstractmethod
    def handle(self, message_type: str, message_data: Dict[str, Any], context: Any) -> Dict[str, Any]:
        """
        Handle the message.
    ...
    def process(self, message_type: str, message_data: Dict[str, Any], context: Any) -> Dict[str, Any]:
        """
...
class TextMessageHandler(MessageHandler):
    ...
    def __init__(self, intent_classifier: IntentClassifier, state_manager: ConversationStateManager):
        """
    ...
    def handle(self, message_type: str, message_data: Dict[str, Any], context: Any) -> Dict[str, Any]:
        ...
        self.state_manager.add_intent(chat_id, {
...
"""
        return {
            ...
            "bot_response": help_text.strip()
        }
    
    def _handle_confirmation_response(self, chat_id: str, text: str, conv_context: Any) -> Dict[str, Any]:
    ...
    def _handle_parameter_response(self, chat_id: str, text: str, conv_context: Any) -> Dict[str, Any]:
